package com.nordnet.vente.test.utils;
...
public class DatabaseExportUtil {
	...
	protected DatabaseExportUtil() {
		...
		try {
			...
			jdbcConnection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test_vente", "test", "test");
	...
	protected void exportDatabaseToDtd() throws IOException, DatabaseUnitException, SQLException {
		...
		// write DTD file
		FlatDtdDataSet.write(connection.createDataSet(), new FileOutputStream("src/test/resources/dtd/vente.dtd"));
	...
	public static void main(final String[] args) {
		...
		try {
			...
			// dbeo.exportDatabaseToSql(Dialect.MYSQL, "com.nordnet.vente.domain.model");

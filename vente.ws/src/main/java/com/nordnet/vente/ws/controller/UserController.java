...
public class UserController extends WadlController {
	...
	@ResponseBody
	public List<com.nordnet.vente.ws.entities.User> getAllUser()
...
//		 return userService.getAllUser();
	...
	public com.nordnet.vente.ws.entities.User updateUserByUserName(
			@RequestBody final UserInfo userInfo) throws ConverterException,
			VenteException {
		// Handle input
		User user = converter.convert(userInfo,
